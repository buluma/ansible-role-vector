...
When you spot an issue, [create an issue](https://github.com/buluma/ansible-role-vector/issues).

Raising the issue helps me and others to find similar problems and solutions in the future.

### [2. Fork the project.](#2-fork-the-project)

On the top right side of [the repository on GitHub](https://github.com/buluma/ansible-role-vector), click `fork`. This copies everything to your GitHub namespace.
...
```shell
git clone git@github.com:YOURNAMESPACE/ansible-role-vector.git
```
